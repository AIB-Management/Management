...
<head>
    ...
    <title>重置密码</title>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/require.min.js" defer async="true" data-main="${pageContext.request.contextPath}/resources/js/resetpwd.js?t=170506-10"></script>
</head>
<body>
<div class="form-wrap">
